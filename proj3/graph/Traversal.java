 ...
 *  marked vertices.
 *  @author JosephHayes, pseudocode from 61b lecture 33
 */
public abstract class Traversal {
    ...
    /** Marked vertices from the fringe. */
    protected ArrayList<Integer> _marked;
    /** List of vertices to be revisited. */
    protected ArrayList<Integer> _post;
    ...
    public void traverse(Collection<Integer> V0) {
        ...
        while (!_fringe.isEmpty()) {
            ...
            if (!marked(vertex)) {
                ...
                if (!_post.contains(vertex) && shouldPostVisit(vertex)) {
                    postVisit(vertex);
                    _post.add(vertex);
                }
            }
